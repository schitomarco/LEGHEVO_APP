...
export function RosterScreen({ league, onNavigate, onOpenPlayer }: Props) {
  ...
  return (
    ...
    >
      ...
      <View style={styles.summaryCard}>
        <View>
          <Text style={styles.summaryLabel}>ROSA COMPLETA</Text>
        ...
        <View style={styles.summaryRow}>
          <SummaryStat
            label="CREDITI"
            value={String(league.team?.creditsRemaining ?? 0)}
          />
      ...
      {roster.loading ? (
        <View style={styles.loadingCard}>
          ...
          <Text style={styles.loadingText}>Controllo i cartellini…</Text>
        </View>
      ) : roster.error ? (
        ...
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.emptyBody}>
            I calciatori acquistati durante l’asta compariranno qui
            automaticamente.
          </Text>
          <Pressable
            ...
            style={styles.primaryButton}
          >
            <Text style={styles.primaryButtonText}>VAI ALL’ASTA</Text>
          </Pressable>
        </View>
      ) : (
