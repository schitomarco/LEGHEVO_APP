-- LEGHEVO v0.62.46
-- Ricertifica il bundle dopo il riallineamento della fixture demo e dei nomi
-- accessibili delle card. La release v0.62.45 resta immutabile per rollback.
...
begin
  ...
  if not coalesce((v_application ->> 'protected')::boolean, false)
    ...
    or coalesce(v_release ->> 'activeVersion', '') not in ('0.62.45', '0.62.46')
    ...
    raise exception 'Preflight v0.62.46 non superato: application=%, release=%, readiness=%.',
...
begin
  loop
    v_claim := public.claim_leghevo_operational_outbox_v2(
      p_environment_key,
      p_destination_key,
      'leghevo-accessibility-demo-fixture-seed-worker',
      10,
    ...
    loop
      v_application_fingerprint := public.leghevo_sha256_hex_v1(
        p_destination_key || '|accessibility-demo-fixture-applied|' ||
      ...
      v_outcome := public.apply_leghevo_operational_consumer_message_v1(
        ...
        gen_random_uuid(),
        jsonb_build_object('seedDelivery', true, 'sourceMigration', 154)
      );
      v_count := v_count + 1;
    end loop;
  end loop;
...
declare
  ...
  v_checksum text := public.leghevo_sha256_hex_v1(
    'leghevo-v0.62.46-accessibility-demo-fixture-artifact');
  ...
  v_actor_hash text := public.leghevo_sha256_hex_v1(
    'accessibility-demo-fixture-custodian');
  v_target_hash text := public.leghevo_sha256_hex_v1(
    'isolated-accessibility-demo-fixture-target');
  v_hash text;
  v_sequence bigint;
begin
  if exists (
    ...
    where certificate.application_version = '0.62.46'
  ) then
    return;
  end if;
  ...
  v_outcome := public.certify_leghevo_operational_consumer_v1(
    ...
    '62a00000-0000-4000-8000-000000000001'::uuid,
    jsonb_build_object('sourceMigration', 154, 'contract', 'accessibility-demo-fixture-v1')
  );
  v_outcome := public.certify_leghevo_operational_consumer_v1(
    'production', 'notification_dispatch', 'leghevo-notification-consumer', 9,
    v_notification_consumer_token,
    '62a00000-0000-4000-8000-000000000002'::uuid,
    jsonb_build_object('sourceMigration', 154, 'contract', 'accessibility-demo-fixture-v1')
  );
  v_outcome := public.certify_leghevo_application_release_v1(
    ...
    '0.62.45',
    '0.62.46',
    '62a00000-0000-4000-8000-000000000003'::uuid,
    jsonb_build_object(
      'baseline', false,
      'sourceMigration', 154,
      'securityPatch', 'accessibility-demo-fixture-v1'
    )
  );
  v_outcome := public.certify_leghevo_application_rollout_v1(
    'production', '0.62.46', 100, 100, 500, 3, 100,
    '62a00000-0000-4000-8000-000000000004'::uuid,
    jsonb_build_object('strategy', 'accessibility-demo-fixture-recertification', 'sourceMigration', 154)
  );
  v_outcome := public.activate_leghevo_release_with_rollout_v1(
    'production',
    '0.62.46',
    '62a00000-0000-4000-8000-000000000005'::uuid,
    '62a00000-0000-4000-8000-000000000006'::uuid,
    'release.accessibility_demo_fixture_activation'
  );
  v_outcome := public.certify_leghevo_operational_telemetry_source_v1(
    ...
    '62a00000-0000-4000-8000-000000000007'::uuid,
    jsonb_build_object('provider', 'leghevo-runtime', 'sourceMigration', 154)
  );
  v_outcome := public.record_leghevo_authoritative_operational_window_v1(
    ...
    '62a00000-0000-4000-8000-000000000008'::uuid,
  ...
  v_outcome := public.run_leghevo_operational_delivery_audit_v1(
    'production',
    '62a00000-0000-4000-8000-000000000009'::uuid,
    jsonb_build_object('sourceMigration', 154, 'accessibilityDemoFixture', true)
  );
  v_checkpoint := public.create_leghevo_disaster_recovery_checkpoint_v1(
    'production',
    '62a00000-0000-4000-8000-000000000010'::uuid,
    'disaster_recovery.release_0_62_45',
    jsonb_build_object('sourceMigration', 154)
  );
  v_outcome := public.run_leghevo_disaster_recovery_drill_v1(
    'production',
    (v_checkpoint ->> 'checkpointId')::bigint,
    '62a00000-0000-4000-8000-000000000011'::uuid,
    jsonb_build_object('sourceMigration', 154, 'accessibilityDemoFixture', true)
  );
  v_artifact := public.register_leghevo_physical_backup_artifact_v1(
    ...
    v_encryption_hash,
    v_actor_hash,
    '62a00000-0000-4000-8000-000000000012'::uuid,
    jsonb_build_object('evidenceMode', 'external_attestation', 'sourceMigration', 154)
  );
  v_outcome := public.append_leghevo_physical_backup_custody_event_v1(
    ...
    v_storage_hash,
    v_now,
    '62a00000-0000-4000-8000-000000000013'::uuid,
  ...
  v_outcome := public.append_leghevo_physical_backup_custody_event_v1(
    ...
    v_storage_hash,
    v_now,
    '62a00000-0000-4000-8000-000000000014'::uuid,
  ...
  v_outcome := public.run_leghevo_external_restore_rehearsal_v1(
    ...
    v_now,
    v_now,
    '62a00000-0000-4000-8000-000000000015'::uuid,
    jsonb_build_object(
      'isolatedTarget', true,
  ...
  v_run := public.begin_leghevo_service_return_v1(
    'production',
    '62a00000-0000-4000-8000-000000000020'::uuid,
    'service_return.accessibility_demo_fixture_restore_verified',
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000021'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000022'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000023'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000024'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000025'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000026'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000027'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  ...
  v_outcome := public.record_leghevo_service_return_check_v1(
    ...
    v_sequence, v_sequence, '62a00000-0000-4000-8000-000000000028'::uuid,
    jsonb_build_object('sourceMigration', 154)
  );
  v_outcome := public.complete_leghevo_service_return_v1(
    'production',
    v_run_id,
    '62a00000-0000-4000-8000-000000000030'::uuid,
    'service_return.accessibility_demo_fixture_certified',
    jsonb_build_object('sourceMigration', 154, 'trafficPercentage', 100)
  );
  v_outcome := public.certify_leghevo_production_readiness_v1(
    'production',
    '62a00000-0000-4000-8000-000000000040'::uuid,
    'production_readiness.accessibility_demo_fixture_certified',
    jsonb_build_object(
      'sourceMigration', 154,
      'applicationVersion', '0.62.46',
      'checkCount', 10
    )
  );
end;
...
begin
  ...
  if coalesce(v_release ->> 'activeVersion', '') <> '0.62.46'
    ...
    or coalesce(v_readiness ->> 'activeVersion', '') <> '0.62.46' then
    raise exception 'Validazione finale v0.62.46 non superata: release=%, readiness=%.',
