# Checklist di collaudo end-to-end LEGHEVO v0.62.43
...
- [ ] La diagnostica v0.62.43 restituisce nuovamente 20/20 sullo staging finale.
- [ ] Migrazione 147 e retry idempotente sono superati sullo staging finale.
